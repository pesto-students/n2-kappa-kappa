  ...
  const handleSubmit = (e) => {
    ...
    setValues((prev) => ({
      ...
      errorMessage: {
        ...
        password: values.password.length < 6 ? 'Password should contain atleast 6 characters.' : '',
        firstName: values.firstName.length < 3 ? 'First name should contain atleast 3 characters.' : '',
        country: values.country.length === 0 ? 'Please select your country' : '',
      },
    }));
  };
      ...
      <form noValidate autoComplete="off">
        <DialogContent className={classes.content}>
          <Typography variant="caption" color="textSecondary" gutterBottom>
            Create you Kappa Member profile and get first
            access to the very best of Kappa products.
          </Typography>
          <TextField
            required
            autoFocus
